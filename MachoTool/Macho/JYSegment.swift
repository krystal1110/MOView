...
//
//        segname = translationStore.translate(next: .rawNumber(16),
...
//
//        vmaddr = translationStore.translate(next: is64Bit ? .quadWords : .doubleWords,
...
//
//        initprot = translationStore.translate(next: .doubleWords,
//                                              dataInterpreter: DataInterpreterPreset.UInt32,
...
//
//        nsects = translationStore.translate(next: .doubleWords,
//                                            dataInterpreter: DataInterpreterPreset.UInt32,
//                                            itemContentGenerator: { value in ExplanationModel(description: "Number of Sections", explanation: "\(value)") })
//
//        flags = translationStore.translate(next: .doubleWords,
